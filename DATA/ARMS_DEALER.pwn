...
CreateArmsPoint()
{
	...
	//JOBS
	new strings[128];
	CreateDynamicPickup(1239, 23, -1632.323974,-2245.587402,31.476562, -1, -1, -1, 50);
	format(strings, sizeof(strings), "{7fffd4}[Black Market]\n{FFFFFF}/creategun");
	CreateDynamic3DTextLabel(strings, COLOR_GREY, -1632.323974,-2245.587402,31.476562, 5.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1); //
}

CMD:creategun(playerid, params[])
{
	if(!IsPlayerInRangeOfPoint(playerid, 3.5, -1632.323974,-2245.587402,31.476562)) return Error(playerid, "Kamu harus di blackmarket!");
	...
	format(Dstring, sizeof(Dstring), "{ffffff}%sColt45 9MM(am1mo 70)\t250\n", Dstring);
	...
	format(Dstring, sizeof(Dstring), "(ffffff}%sSOS(150 Ammo)\t750\n", Dstring);
