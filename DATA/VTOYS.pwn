	...
	{	
		...
		foreach(new i: PVehicles)
		{
			if(x == pvData[i][cVeh])
			{
				...
				ShowPlayerDialog(playerid, DIALOG_MODTBUY, DIALOG_STYLE_LIST, ""RED_E"Amazed Roleplay: "WHITE_E"Vehicle Toys", string, "Select", "Cancel");
			}
		}
	}
...
CMD:vtoys(playerid)
{
	...
	{	
		...
		if(x == pvData[i][cVeh])
		{
			...
			ShowPlayerDialog(playerid, DIALOG_MODTOY, DIALOG_STYLE_LIST, ""RED_E"Amazed Roleplay: "WHITE_E"Vehicle Toys", string, "Select", "Cancel");
		}
	}
	else return Error(playerid, "Anda harus mengendarai kendaraan!");
