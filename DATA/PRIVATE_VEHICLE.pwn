...
function OnVehStarterpack(playerid, pid, model, color1, color2, Float:x, Float:y, Float:z, Float:a)
{
	...
	Iter_Add(PVehicles, i);
	OnPlayerVehicleRespawn(i);
	Servers(playerid, "Kamu telah mengambil Startepack kota, 1 Faggio & 1500$");
	return 1;
}
...
GetVehicleStorage(vehicleid, item)
{
	static const StorageLimit[][] = {
	   //Medicine  Medkit  Bandage  Seed  Material  Component  Marijuana   Tembaga besi emas aluminium 
	    {300,    300,     500,  	  500,  	  500,  	   500,  150,  	   150, 	 150,     150,      150,      150,      150,  150  }
	};
