...
CMD:modshop(playerid, params[])
{
	...
	{
		ShowPlayerDialog(playerid, DIALOG_MODMENU, DIALOG_STYLE_LIST, "Vehicle Modshop Amazed", "Beli Toys Kendaraan\nPasang Parasut Pada Kendaraan", "Pilih", "Tutup");
	}	
	return 1;
}